...
impl FanucLrMate200id {
    ...
    pub fn end_pose(&self) -> XyzWpr {
        ...
        // let base = XyzWpr::new(0.0, 0.0, 0.0, 180.0, -90.0, 0.0).to_isometry();
        // let working = last * base;
        // XyzWpr::from_isometry(&working)
...
mod tests {
    ...
    #[test_case((0.0, 0.0, 0.0, -15.0, 0.0, 0.0), (465.0, 0.0, 365.0, -90.0, -75.0, -90.0))] // what
